...
public class main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        txBuilder.addOperation(new PaymentOperation.Builder("GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR",
                                                            myAsset,
                                                            "0.03").build());
        ...
        for (int i = 1; i <= 100; i++) {
            ...
            txBuilder.addOperation(
                new PaymentOperation.Builder("GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR",
                                             myAsset,
                                             amount).build());
