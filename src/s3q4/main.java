...
public class main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Transaction preAuthTx =  new Transaction.Builder(bumpedQuestAccount, Network.TESTNET).setBaseFee(FeeBumpTransaction.MIN_BASE_FEE).setTimeout(180).addOperation( new PaymentOperation.Builder(signer3PublicKey, myAsset, "1").build()).build();
