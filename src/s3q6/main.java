...
/*
* Data provided: https://api.stellar.quest/badge/GCEE5H3RI2MFP4UQ4NHFKLGTIHILWA775AM7KTLU5HUBSLOBJN7M4RSL?network=public&v=1
*
*
 */
package s3q6;
...
public class main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // ImageBase64 iB64= new ImageBase64("https://api.stellar.quest/badge/GCEE5H3RI2MFP4UQ4NHFKLGTIHILWA775AM7KTLU5HUBSLOBJN7M4RSL?network=public&v=1");
        // String imageString = iB64.getImageBase64String();
        // System.out.println(imageString);
        ManageDataOperation operation;
        byte[]              b       = badgeToBase64.getBytes(StandardCharsets.UTF_8);
        int                 counter = 0;
        int                 limit   = 12244;
        String              buff1, name,
                            value   = "";
        ...
        buff1 = badgeToBase64;
        System.out.println(badgeToBase64);
        ...
        for (int i = 0; i < buff1.length(); i = i + 126) {
            ...
            operation = new ManageDataOperation.Builder(name,
                                                        value.getBytes(StandardCharsets.UTF_8)).setSourceAccount(
                                                            questAccountKeys.getAccountId())
                                                                                               .build();

            // value as 'null' to remove data entry
            // operation = new ManageDataOperation.Builder(name,null).setSourceAccount(questAccountKeys.getAccountId()).build();
            System.out.println(name);

            if (counter == 97) {

                // LAst97 name must be: MrMrjfAAAAAElFTkSuQmCC
        ...
        // 12244
        System.out.println(badgeToBase64.length());
